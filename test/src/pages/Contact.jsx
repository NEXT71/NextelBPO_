      ...
      <section className="relative py-40 bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 text-white overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          <div className="inline-flex items-center gap-4 bg-black/20 backdrop-blur-lg border border-purple-500/20 rounded-full px-6 py-3 mb-8">
            ...
            <span className="text-purple-100 text-sm font-mono">Communication Hub: ONLINE</span>
                    ...
                    <div className="group flex items-start gap-4 p-4 rounded-2xl hover:bg-purple-500/10 transition-all duration-300">
                      ...
                      <div>
                        ...
                        <p className="text-slate-400">
                          <a href="tel:+923705546296" className="hover:text-purple-400 transition-colors duration-300">+92 (370) 554-6296</a>
                        </p>
                      </div>
                    </div>
